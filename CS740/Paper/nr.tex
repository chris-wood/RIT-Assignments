...
\begin{document}
\arltitle{Engineering Networks for Optimal Robustness}{4005-700 Data Communication and Networks I}
...
Finally, we introduce a metric that characterized the number of nodes (or rather, a fraction of the total nodes) that need to be removed in order for the graph to become globally disconnected.
...
\begin{itemize}
	\item \textbf{ID removal} - initial degree distribution vertex removal
	\item \textbf{IB removal} - initial betweenness distribution vertex removal
	\item \textbf{RD removal} - recalculated degree distribution vertex removal
	\item \textbf{RB removal} - recalculated betweenness distribution vertex removal
\end{itemize}
