...
public class LogService implements ILogService 
{
	...
	public String newTicket() throws IOException 
	{
		...
		if (isIOReady())
		{
			...
			serverOut.writeBytes(ILogService.TKT + ILogService.MSG_END);
	...
	public void addEntry(String ticket, String message) 
	{
		try 
		{
			if (isIOReady())
			{
				serverOut.writeBytes(ILogService.LOG + ticket + ILogService.MSG_DIVIDER 
						+ message + ILogService.MSG_END);
			}
		} 
		catch (IOException e) 
		{
	...
	public List<String> getEntries(String ticket) throws IOException 
	{
		...
		if (isIOReady())
		{
			...
			serverOut.writeBytes(ILogService.GET + ticket + ILogService.MSG_END);
	...
	public void releaseTicket(String ticket) 
	{
		try 
		{
			if (isIOReady())
			{
				serverOut.writeBytes(ILogService.REL + ticket + ILogService.MSG_END);
			}
		} 
		catch (IOException e) 
		{
