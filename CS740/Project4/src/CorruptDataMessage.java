 ...
 */
public class CorruptDataMessage extends TFTPmessage 
{
	/**
	 ...
	 */
	public CorruptDataMessage (int number, byte[] data, int port)
	{
		blockNumber = number;
		this.data = data;
		this.port = port;
	 ...
	 */
	public CorruptDataMessage (DatagramPacket packet)
	{
	...
	{
		StringBuilder builder = new StringBuilder("CDATA[" + blockNumber + "]: ");
		for (int i = 0; i < data.length; i++)
		{
