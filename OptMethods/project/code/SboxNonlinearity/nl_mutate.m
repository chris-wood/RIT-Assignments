function children = nl_mutate( parents, options, GenomeLength, FitnessFcn, state, thisScore, thisPopulation )
...
% Rotate the children for more randomness
for i = 1:mutationPop
   children(i) = mod(children(i) + 1, mutationPop)
end
