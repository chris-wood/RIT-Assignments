...
//			}
		...
		{	
		    	...
		    	// three fine-grained tasks: 1) matrix sum, 2) swap, 3) check - are these really "tasks"?
		    {
			    ...
			    for (int i = 0; i < n; i++) // TODO: parallel team integer for loop here
			    {
			    			...
			    			(x[index] + y[index])) < epsilon)) 
			    	{
			    		...
			    		iterSuccess = oldVal; // JVM guarantees atomic set of this variable
			    	}
			    	
			    	// TODO: swap sequentially (in the parallel region for loop)
			    }
